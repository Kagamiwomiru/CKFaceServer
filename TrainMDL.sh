#!/bin/bash
#モデルの比較実験を行います。
mkdir OUTPUT_MODEL/Xce & mkdir OUTPUT_MODEL/VGG16 & mkdir OUTPUT_MODEL/VGG19 & mkdir OUTPUT_MODEL/RES & mkdir OUTPUT_MODEL/incV3 & mkdir OUTPUT_MODEL/InRes &  mkdir OUTPUT_MODEL/Nas_L & mkdir OUTPUT_MODEL/Nas_M 
for i in `seq 7`
do
