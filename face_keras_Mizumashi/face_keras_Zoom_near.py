...
#ImageGenerator
os.mkdir(temp_dir) 
test_data=ImageDataGenerator(zoom_range=0.5,fill_mode='nearest')
mizumashi_data=ImageDataGenerator(zoom_range=0.5,fill_mode='nearest')
val_datagen=ImageDataGenerator(zoom_range=0.5,fill_mode='nearest')
