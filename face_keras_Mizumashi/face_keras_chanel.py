...
#ImageGenerator
os.mkdir(temp_dir) 
test_data=ImageDataGenerator(channel_shift_range=50)
mizumashi_data=ImageDataGenerator(channel_shift_range=50)
val_datagen=ImageDataGenerator(channel_shift_range=50)
